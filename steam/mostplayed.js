...
async function crawlingTopSeller(driver) {
  try {
    ...
    await driver.get("https://store.steampowered.com/charts/mostplayed/");
    await driver.wait(
      until.elementLocated(
        By.xpath(
          "/html/body/div[1]/div[7]/div[6]/div/div[4]/div/div/div/div/div[3]/table/tbody/tr[1]/td[3]/a/div" // 1st title
        )
      )
    );
    for (let i = 1; i < 11; i++) {
      // 1위~10위
      const xpath = `/html/body/div[1]/div[7]/div[6]/div/div[4]/div/div/div/div/div[3]/table/tbody/tr[${i}]/td[3]/a`;
      const title = `/div`;
